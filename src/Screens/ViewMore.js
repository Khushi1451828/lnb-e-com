...
function ViewMore()
{
  ...
  <div class="card-body">
    ...
    <h6 class="card-title">Discount &#8377;{(state.price - (state.price*(state.discountPercentage/100))).toFixed(2)}</h6>
    <h6 class="card-title">MRP <s>  &#8377;{state.price} ({state.discountPercentage+"%"})</s></h6>
